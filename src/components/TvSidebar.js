...
// helpers
import { fetchTvData, fetchTvGenres, fetchTvGenresData } from "../helpers/fetchTv";
...
const TvSidebar = ({ setDynamicState, pageNumber, setPageNumber, value, setValue, genres, setGenres }) => {

    useEffect(() => {
        fetchTvGenres(setGenres)
        setValue(value)
    }, [])
    ...
    useEffect(() => {
        ...
        if (value === 'top_rated') {
            setValue('top_rated')
            fetchTvData(value, setDynamicState, pageNumber)
        } else if (value === 'popular') {
            setValue('popular')
            fetchTvData(value, setDynamicState, pageNumber)
        } else {
            setValue(value)
            fetchTvGenresData(value, setDynamicState, pageNumber)
        }
